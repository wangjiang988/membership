...
<!-- END SIDEBAR -->
    ...
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption"><i class="icon-reorder"></i>站点信息</div>
            <!--<div class="tools">-->
        ...
        <div class="portlet-body form">
            ...
            <table class="table table-striped table-bordered" id="sample_1">
                ...
                <tbody>
                <?php if(!empty($site)): ?><tr class="odd gradeX">
                        <td class="input-title"><input style="display: none;"/>站点名称</td>
                        <td class="input-value editable" data-name="name"><?php echo ($site["name"]); ?></td>
                        <td class="input-tips"><input style="display: none;"/><?php echo L('site_name_tips');?></td>
                    </tr>
                    <tr class="odd gradeX">
                        <td class="input-title"><input style="display: none;"/>关键字</td>
                        <td class="input-value editable" data-name="keywords"><?php echo ($site["keywords"]); ?></td>
                        <td class="input-tips"><input style="display: none;"/><?php echo L('site_keywords_tips');?> </td>
                    </tr>
                    <tr class="odd gradeX">
                        <td class="input-title"><input style="display: none;"/>描述</td>
                        <td class="input-value editable" data-name="description"><?php echo ($site["description"]); ?></td>
