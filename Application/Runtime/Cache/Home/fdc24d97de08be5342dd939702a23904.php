...
<div class="portlet box light-grey">
    ...
    <div class="portlet-body">
        ...
        <div class="clearfix">
            ...
            <div style="display: inline-block;padding-left: 40px;" >
                <form action="<?php echo U('Member/index');?>" method="post" style="margin: 0;">
                    <input type="text" name="search_name" value="<?php echo ($search["search_name"]); ?>" placeholder="请输入查询的会员名"/>
                    <input type="text" name="search_card" value="<?php echo ($search["search_card"]); ?>" placeholder="请输入查询的会员卡号"/>
                    <input type="text" name="search_phone" value="<?php echo ($search["search_phone"]); ?>" placeholder="请输入查询的会员手机号"/>
            ...
            <div class="btn-group pull-right">
                ...
                <ul class="dropdown-menu pull-right">
                    ...
                    <li><a href="<?php echo U('Member/outExcel');?>">导出到Excel</a></li>
                    <!--<li> <a id="inExcel" href="javascript:;">导入Excel</a>-->
                        <form n id="excelForm" action="<?php echo U('Member/inExcel');?>"  method="post"  enctype="multipart/form-data">
        ...
        <table class="table table-striped table-bordered" id="sample_1">
            ...
            <?php if(!empty($list["list"])): if(is_array($list["list"])): $i = 0; $__LIST__ = $list["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX" id="<?php echo ($vo["id"]); ?>">
                    ...
                    <td class="" data-name="birth"  data-id="<?php echo ($vo["id"]); ?>"><?php echo ($vo["birth"]); ?></td>
                    <td class="editable" data-name="phone"  data-id="<?php echo ($vo["id"]); ?>"> <?php echo ($vo["phone"]); ?> </td>
                    <td><?php if($vo["phone_status"] == 1): ?><span class="label label-success">已激活
                            </span><?php else: ?><span class="label label-danger">未激活</span><?php endif; ?></td>
                    <td class="" data-name="create_at"><?php echo (date("Y-m-d H:i",$vo["create_at"])); ?></td>
                    <td><?php if($vo["status"] == 1): ?><span class="label label-success">可用</span><?php else: ?><span class="label label-danger">禁止</span><?php endif; ?></td>
                    <td><a href="javascript:getCards(<?php echo ($vo["id"]); ?>);">会员卡</a></td>
    ...
    <div id="addModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-header">
            ...
            <h3 id="addModalLabel">新增会员</h3>
        </div>
        <form action="<?php echo U('Member/create');?>" id="addForm" method="post" class="form-horizontal">
            <div class="modal-body">
                <div class="portlet-body form">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input type="text" id="birth" name="birth" readonly class="span6 m-wrap" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select class="span6 chosen" name="status" id="status" data-placeholder="Choose a Category" tabindex="1">
...
<!-- BEGIN CORE PLUGINS -->
    ...
    <script src="/Public/media/js/member-managed.js"></script>

    <script>


        jQuery(document).ready(function() {
            viewUrl = "<?php echo U('Member/view');?>";
            getCardsUrl = "<?php echo U('Member/getCards');?>";
